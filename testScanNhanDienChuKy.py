import customtkinter  # Giao diện nâng cao dựa trên Tkinter (tối màu, hiện đại)
from tkinter import filedialog, messagebox, Toplevel, Label  # Các tiện ích giao diện cơ bản
import google.generativeai as genai  
from PIL import Image, ImageTk, ImageDraw  # Xử lý ảnh: mở, vẽ, hiển thị trong giao diện
import os  
import threading  # Chạy song song để tránh treo giao diện khi xử lý nặng
import json  # Lưu và đọc dữ liệu dưới dạng JSON
import re  # Biểu thức chính quy (regex) để xử lý chuỗi (lọc, trích xuất văn bản)
import pyodbc  # Kết nối và thao tác với SQL Server
from typing import Dict, Optional, Tuple  # Gợi ý kiểu dữ liệu (type hint trong Python)
